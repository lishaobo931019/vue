...
//	var echarts = require('echarts');//引入echarts
	export default{
		...
		mounted() {
			...
			var biddingProportion = this.echarts.init(document.getElementById('biddingProportion'));//中标占比情况
            ...
            biddingProportion.showLoading();
            this.$http.biddingProportion().then(function(res){	
                biddingProportion.hideLoading();
                biddingProportion.setOption({
                    legend: {
...
#echartsBiddinginfo{
	...
	#biddingNum,#biddingMoney,#biddingProportion{
		margin: 20px;
